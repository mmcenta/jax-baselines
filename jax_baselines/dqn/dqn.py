...
from jax_baselines.dqn.replay import ReplayBuffer, PrioritizedReplayBuffer
...
def learn(rng, env_fn, net_fn,
          ...
          double_q=False, prioritized_replay=False, alpha=0.6,
          beta=0.4, beta_scheduler=None,
    ...
    if prioritized_replay:
        buffer = PrioritizedReplayBuffer(buffer_size, dummy_obs, dummy_act,
            alpha=alpha)
    else:
